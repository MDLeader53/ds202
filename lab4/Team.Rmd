...
author: "Matthew Peterson (MDLeader53), Shivam Vashi(SVashi) " 
...
```{r}
bioClean %>% full_join(offClean,by='Name')
print(bioClean)
```
2. Is there a relationship between the weight of a player and the receiving yards (`Receiving_YDS`)?
```{r,echo=FALSE,results='hide'}
ggplot(bioClean, aes(bioClean$Weight, bioClean$Receiving_YDS)) + geom_point()
```
...
>>>>>>> b469bd22dcc656694a0d2fe7597165c994b1b738
